        ...
        <div className="flex min-h-[80vh] items-center justify-center px-4">
            <Card variant="panel" className="w-full max-w-md p-6 sm:p-8">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-white/60">Sign in to continue studying with Quiziq</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="flex flex-col gap-4 mt-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/forgot-password" className="text-sm text-glow hover:underline">
                            Forgot password?
                        </Link>
                    </div>
